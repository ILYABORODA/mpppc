 ...
 * Plugin URI:        https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=plugin-uri
 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '6.4.3.3' );
define( 'AYS_QUIZ_VERSION', '6.4.3.3' );
    ...
    if ( isset( $_GET['page'] ) && strpos( sanitize_text_field( $_GET['page'] ), AYS_QUIZ_NAME ) !== false ) {
            ...
            <div class="navigation-bar">
                <div id="navigation-container">
                    <div class="logo-container">
                        <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=banner-quiz-logo" target="_blank" style="display: inline-block;box-shadow: none;">
                    ...
                    <ul id="menu">
                        <li class="modile-ddmenu-xss"><a class="ays-btn" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=banner-pro" target="_blank"><i class="ays_fa ays_fa_diamond ays-fa-margin-right"></i>PRO</a></li>
        ...
        <div class="ays_ask_question_content">
            <div class="ays_ask_question_content_inner">
                <a href="https://wordpress.org/support/plugin/quiz-maker/" class="ays_quiz_question_link" target="_blank">Ask a question</a>
