                        ...
                        <thead>
                            ...
                            <?php endif; ?>
                                <th class="only_pro ays-weight-row ays-quiz-question-answer-weight-point-row" style="width:120px;padding:0;"><?php echo __('Weight/Point', $this->plugin_name); ?><br>
                                    <a style="text-transform: capitalize;" tabindex="-1" class="only_pro_lik" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-weight-point" target="_blank" title="PRO feature"><?php echo __("PRO feature!!!", $this->plugin_name); ?></a>
                                </th>
                            <?php if( $question["type"] == 'checkbox' || $question["type"] == 'radio' || $question["type"] == 'select' || $question["type"] == 'true_or_false' ): ?>
                                <th class="only_pro th-150 removable ays-quiz-question-answer-keyword-row" style="width:120px;padding:0;">
                                    ...
                                    <a style="text-transform: capitalize;" tabindex="-1" class="only_pro_lik" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-keyword" target="_blank" title="PRO feature"><?php echo __("PRO feature!!!", $this->plugin_name); ?></a>
                                </th>
                            <?php endif; ?>
                            ...
                            <tr class="ays-answer-row ui-state-default <?php echo $ays_even_or_not; ?>">
                                ...
                                <td title="This property aviable only in pro version" class="ays-quiz-question-answer-image-row">
                                    <label class='ays-label' for='ays-answer'>
                                        <a style="opacity: 0.4" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-answer-image" target="_blank" class="add-answer-image" tabindex="-1"><?php echo __('Add',$this->plugin_name)?></a>
                                    </label>
                                </td>
                        ...
                        <?php
                            ...
                            foreach ($answers as $index => $answer) {
                                ...
                                <tr class="ays-answer-row ui-state-default <?php echo $class; ?>">
                                    ...
                                    <td title="This property aviable only in pro version" class="ays-quiz-question-answer-image-row">
                                        <label class='ays-label' for='ays-answer'>
                                            <a style="opacity: 0.4" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-answer-image" tabindex="-1" target="_blank" class="add-answer-image"><?php echo __('Add',$this->plugin_name)?></a>
                                        </label>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" class="ays-delete-answer">
                        ...
                        <div class="pro_features">                            
                            <div>
                                <p>
                                    ...
                                    <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-question-weight" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:15px;">
                        <div class="pro_features">                            
                            <div>
                                <p>
                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                    <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-question-tag" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:15px;">
                        <div class="pro_features">                            
                            <div>
                                <p>
                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                    <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-background-image" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <a href="javascript:void(0)" class="add-question-image m-0" tabindex="-1">Add Image</a>
                            </div>
                            <div class="col-sm-5">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:15px;">
                        <div class="pro_features">                            
                            <div>
                                <p>
                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                    <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=user-answer-explanation" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
