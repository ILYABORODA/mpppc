...
<div class="wrap ays-quiz-list-table ays_questions_list_table">
    ...
    <div class="question-action-butons">
        ...
        <div class="ays-quiz-pro-features-box" style="position: relative; margin-right: 10px;" title="<?php echo __('This property aviable only in pro version',$this->plugin_name); ?>">
            ...
            <div> 
                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-export-import" target="_blank" title="<?php echo __('This property aviable only in pro version',$this->plugin_name); ?>" class="button disabled-button"><?php echo __('Export to', $this->plugin_name); ?></a>
            </div>
        </div>
        <div class="ays-quiz-pro-features-box" style="position: relative; margin-right: 10px;" title="<?php echo __('This property aviable only in pro version',$this->plugin_name); ?>">
            <div class="pro_features pro_features_popup">
            ...
            <div>
                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-export-import" target="_blank" title="<?php echo __('This property aviable only in pro version',$this->plugin_name); ?>" class="button disabled-button" aria-expanded="false"><?= __('Import', $this->plugin_name); ?></a>
            </div>
        </div>
    </div>
