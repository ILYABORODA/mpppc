                                    ...
                                    <div class="pro_features" style="">
                                        <div>
                                            <p style="font-size:20px;">
                                                ...
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=keyword-default-count" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-sm-12" style="padding:20px;">
                                    <div class="pro_features" style="justify-content:flex-end;">
                                        <div>
                                            <p style="font-size:20px;">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=store-not-finished-results" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features" style="">
                                        <div>
                                            <p style="font-size:20px;">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=who-will-have-permission" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                    ...
                    <div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row" style="padding:0px;margin:0;">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-individual-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                            <p class="position-relative ays-quiz-pro-features-text">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-individual-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                        <div class="ays-quiz-preview-button-box">
                                            <a href="https://quiz-plugin.com/individual-leaderboard/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-global-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                            <p class="position-relative ays-quiz-pro-features-text">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-global-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                        ...
                                        <div class="ays-quiz-preview-button-box">
                                            <a href="https://quiz-plugin.com/global-leaderboard-2/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-12 only_pro" style="padding:20px;">
                                <div class="pro_features pro_features_background_bolder" style="">
                                    <div>
                                        <p class="position-relative" style="font-size:20px;">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                            <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-category-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                        </p>
                                        <p class="position-relative ays-quiz-pro-features-text">
                                            <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                            <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-category-leaderboard" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                    ...
                                    <div class="ays-quiz-preview-button-box">
                                        <a href="https://quiz-plugin.com/leaderboard-by-quiz-category/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-user-page" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                        <div class="ays-quiz-preview-button-box">
                                            <a href="https://quiz-plugin.com/user-page-2/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-flash-card" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                        <div class="ays-quiz-preview-button-box">
                                            <a href="https://quiz-plugin.com/flash-cards/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                        </div>
                                    </div>
                                    <div class="form-group row" style="padding:0px;margin:0;">
                                        <div class="col-sm-12" style="padding:20px;">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-recent-quizzes" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                        <div class="ays-quiz-preview-button-box">
                                            <a href="https://quiz-plugin.com/recent-quizzes/" target="_blank" class="ays-quiz-preview-button"><?php echo __("View Demo", $this->plugin_name); ?></a>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p class="position-relative" style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-some-of-quiz-points" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row" style="padding:0px;margin:0;">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-quiz-orders" target="_blank" title="PRO feature"><?php echo __("Developer version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row" style="padding:0px;margin:0;">
                                ...
                                <div class="col-sm-12 only_pro" style="padding:20px;">
                                    <div class="pro_features pro_features_background_bolder" style="">
                                        <div>
                                            <p style="font-size:20px;">
                                                    <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=general-settings-quiz-multilanguage" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row" style="padding:0px;margin:0;">
                            ...
                            <div class="col-sm-12" style="padding-top: 10px;;">
                                <div class="pro_features" style="">
                                    <div>
                                        <p style="font-size:20px;">
                                                <?php echo __("This feature is available only in ", $this->plugin_name); ?>
                                            <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=message-variables" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                        </p>
