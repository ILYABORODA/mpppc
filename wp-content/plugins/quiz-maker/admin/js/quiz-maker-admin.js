    ...
    $(document).ready(function () {
        ...
        $(document).find('#ays-type').on('change', function(e){
            ...
            if($(this).val() == 'date'){
                ...
                if($(document).find('table#ays-answers-table tbody').hasClass('text_answer') || true_or_false_flag){
                    ...
                    var keyworHtml = '<th class="only_pro th-150 removable" style="width:120px;padding:0;">Keyword<br><a style="text-transform: capitalize;" tabindex="-1" class="only_pro_lik" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-keyword" target="_blank" title="PRO feature">PRO feature!!!</a></th>';
                        ...
                        var answerRow = '<tr class="ays-answer-row ui-state-default">'+
                                    ...
                                    '<td title="This property aviable only in pro version" class="ays-quiz-question-answer-image-row">'+
                                        ' <label class="ays-label" for="ays-answer">'+
                                            '<a style="opacity: 0.4" href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=question-page-answer-image" tabindex="-1" target="_blank" class="add-answer-image">Add</a>'+
                                        '</label>'+
                                    '</td>'+
        ...
        $(document).on('click', '.pro_features_popup', function(e){
            ...
            if ( typeof popupModal_video_link != "undefined" && popupModal_video_link != "") {
                ...
                var iframeHTML = '<iframe width="560" height="315" src="https://www.youtube.com/embed/'+ videoID +'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
