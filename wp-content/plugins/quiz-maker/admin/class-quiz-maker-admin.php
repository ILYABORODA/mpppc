    ...
    public function add_action_links($links){
        ...
        */
        $settings_link = array(
            ...
            '<a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=plugin-menu-buy-now" target="_blank" style="color:red;font-weight:bold;">' . __('Buy Now', $this->plugin_name) . '</a>',
            );
    ...
    */
        ...
        if($ishmar == 0 ){
            ...
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month">';
                    $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" target="_blank" class="ays-quiz-sale-banner-link"><img src="' . AYS_QUIZ_ADMIN_URL . '/images/mega_bundle_logo_box.png"></a>';

                    $content[] = '<div class="ays-quiz-dicount-wrap-box">';

                        $content[] = '<strong style="font-weight: bold;">';
                            $content[] = __( "Limited Time <span style='color:#E85011;'>50%</span> SALE on <br><span><a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank' style='color:#E85011; text-decoration: underline;'>Mega Bundle</a></span> (Quiz + Survey + Poll)!", AYS_QUIZ_NAME );
                        $content[] = '</strong>';

                        $content[] = '<br>';

                        $content[] = '<strong>';
                                $content[] = __( "Hurry up! <a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank'>Check it out!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
                    ...
                    $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="button button-primary ays-button" id="ays-button-top-buy-now" target="_blank" style="height: 32px; display: flex; align-items: center; font-weight: 500; " >' . __( 'Buy Now !', AYS_QUIZ_NAME ) . '</a>';
                $content[] = '</div>';
            $content[] = '</div>';
    ...
    public function ays_quiz_sale_message_christmas_bundle(){
        ...
        $content[] = '<div id="ays-quiz-winter-dicount-main">';
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month">';
                    $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" target="_blank" class="ays-quiz-sale-banner-link"><img src="' . AYS_QUIZ_ADMIN_URL . '/images/mega_bundle_christmas_box.png"></a>';

                    $content[] = '<div class="ays-quiz-dicount-wrap-box">';

                        $content[] = '<strong>';
                            $content[] = __( "The BIGGEST <span class='ays-quiz-dicount-wrap-color' style='color:#000;'>50%</span> SALE on <br><span><a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank' class='ays-quiz-dicount-wrap-color ays-quiz-dicount-wrap-text-decoration' style='display:block;color:#000'>Christmas Bundle</a></span> (Quiz+Survey+Poll)!", AYS_QUIZ_NAME );
                        $content[] = '</strong>';

                        $content[] = '<br>';

                        $content[] = '<strong>';
                                $content[] = __( "Hurry up! Ending on. <a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank' style='color:#000;'>Check it out!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
                    ...
                    $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="button button-primary ays-button" id="ays-quiz-button-top-buy-now" target="_blank">' . __( 'Buy Now !', AYS_QUIZ_NAME ) . '</a>';
                $content[] = '</div>';
            $content[] = '</div>';
        // $content[] = '</div>';
                ...
                $content[] = '<div id="ays-quiz-dicount-month-helloween" class="ays_quiz_dicount_month_helloween">';
                    $content[] = '<div class="ays-quiz-dicount-wrap-box-helloween-limited">';
                        ...
                        $content[] = '<p>';
                            ...
                            <span style='' class='ays-quiz-helloween-bundle'>
                                <a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank' class='ays-quiz-dicount-wrap-color-helloween ays-quiz-dicount-wrap-text-decoration-helloween' style='display:block; color:#b2ff00;margin-right:6px;'>
                                    Mega Bundle
                                </a>
                                (Quiz + Survey + Poll)!
                            </span>", AYS_QUIZ_NAME );
                        ...
                        $content[] = '<p>';
                                $content[] = __( "Hurry up! 
                                                <a href='https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega' target='_blank' style='color:#ffc700;'>
                                                    Check it out!
                                                </a>", AYS_QUIZ_NAME );
                        $content[] = '</p>';
                    ...
                    $content[] = '<div class="ays-quiz-helloween-bundle-buy-now-timer">';
                        ...
                        $content[] = '<div class="ays-quiz-dicount-wrap-box ays-buy-now-button-box-helloween">';
                            $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="button button-primary ays-buy-now-button-helloween" id="ays-button-top-buy-now-helloween" target="_blank" style="" >' . __( 'Buy Now !', AYS_QUIZ_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                ...
                $content[] = '<div id="ays-quiz-dicount-christmas-month" class="ays_quiz_dicount_month">';
                    $content[] = '<div class="ays-quiz-dicount-christmas-box">';
                        $content[] = '<div class="ays-quiz-dicount-christmas-wrap-box ays-quiz-dicount-christmas-wrap-box-80">';
                            $content[] = '<div class="ays-quiz-dicount-christmas-title-row">' . __( 'Limited Time', AYS_QUIZ_NAME ) .' '. '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="ays-quiz-dicount-christmas-button-sale" target="_blank">' . __( '50%', AYS_QUIZ_NAME ) . '</a>' . ' SALE on</div>';
                            $content[] = '<div class="ays-quiz-dicount-christmas-title-row">'. '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="ays-quiz-dicount-christmas-button-sale ays-quiz-dicount-christmas-button-block" target="_blank">' . __( 'Mega Bundle', AYS_QUIZ_NAME ) . '</a>' . __( '(Quiz + Survey + Poll)!', AYS_QUIZ_NAME ) . '</div>';
                        $content[] = '</div>';
                        ...
                        $content[] = '<div class="ays-quiz-dicount-christmas-wrap-box" style="width: 25%;">';
                            $content[] = '<a href="https://ays-pro.com/mega-bundle?utm_source=dashboard-mega&utm_medium=free-mega&utm_campaign=quiz-mega" class="ays-quiz-dicount-christmas-button-buy-now" target="_blank">' . __( 'BUY NOW!', AYS_QUIZ_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                $content[] = '</div>';
    ...
    */
    ...
    public function add_tabs() {
        ...
        */
        ...
        '<p><a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-free&utm_campaign=screen-options-help" target="_blank">' . __( 'Quiz Maker plugin premium version', AYS_QUIZ_NAME ) . '</a></p>' .
        ...
        $plugins_array = array(
           'poll-maker/poll-maker-ays.php'        => array(
            ...
            'survey-maker/survey-maker.php'        => array(
                ...
                'buy_now'     => 'https://ays-pro.com/wordpress/survey-maker?utm_source=dashboard-our-products&utm_medium=free&utm_campaign=quiz',
