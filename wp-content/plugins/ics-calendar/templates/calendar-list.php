...
// Note: vents are grouped by date, so exact pagination count will be *at least* this value
						...
						foreach ((array)$days as $day => $day_events) {
							...
							if (!empty($pagination)) {
								if ($p_i == 0 && empty($pagination_open)) {
									?>
									<div class="ics-calendar-list-pagination" data-page="<?php echo intval($p_c); ?>">
									<?php
