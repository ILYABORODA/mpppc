if ( window.jQuery ) {
	jQuery( document ).ready( function ($) {
		...
		let $lgx_logo_slider_copy_button = $( '.lgx_parallax_admin_copy_code_btn' );
		let $lgx_icon_image_button     = $( '.lgx_icon_image_button' );
		let $lgx_icon_image_button_clear = $( '.lgx_icon_image_button_clear' );
		let $lgx_logo_slider_showcase_type = $( '.lgx_meta_parallax_type' );
		...
		$lgx_logo_slider_showcase_type.on( 'change', function (event) {
			...
			switch (logoSliderLayout) {
				case 'css':
					$lgx_logo_slider_layout.html( '<i class="dashicons dashicons-images-alt2"></i> CSS' );
					break;

				case 'jquery':
					$lgx_logo_slider_layout.html( '<i class="dashicons dashicons-images-alt"></i> jQuery' );
					break;
