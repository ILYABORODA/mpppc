...
/**
 * Version: 1.0.0
 * Last Update Date: 24.11.22
 */




class ClassParallaxScrollWpMetaForm {
    
    private $lgx_meta_from_plugin_name;
    private $lgx_pro_ready; // yes, no

    public function __construct() {
        $this->lgx_meta_from_plugin_name = LGX_PARALLAX_PLUGIN_TEXT_DOMAIN;
        $this->lgx_pro_ready             = 'no';
    }

    

    public function lgx_allowed_tags() {
        ...
        $lgx_arr = array( 
                    ...
                    'button' => array(
                        ...
                        'id'        => array(),
                        'class'     => array(),
                        'data-icon-field-name'     => array(),
                        'data-icon-img-id'     => array(),
                    ),
    ...
    public function switch( array $args ) {
        ...
        if( $status  == 'disabled' && $this->lgx_pro_ready == 'no') { return '';}

        if ( ! isset( $args['id'], $args['name'] , $args['label'] ) ) {
            return;
        }

        $yes_label     = isset( $args['yes_label'] ) ? $args['yes_label'] : __('ON', $this->lgx_meta_from_plugin_name);
        $no_label    = isset( $args['no_label'] ) ? $args['no_label'] : __('OFF', $this->lgx_meta_from_plugin_name);
       // $status       = isset( $args['status'] ) ? $args['status'] : '';
        $is_pro       = (( $status == 'disabled') ? 'disabled' : '');
        $is_pro_label = (( $status== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span>' : '');
        ...
        $meta          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
       ...
       echo wp_kses( $output, $this->lgx_allowed_tags());
    }
    ...
    public function bgColorTypo(array $args) {
        ...
        $meta_color          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_color     = (( $status_color == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');

        // label_hColor
        $default_value_hColor = isset( $args['default_hColor'] ) ? $args['default_hColor'] : '';
        $meta_hColor          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_hColor     = (( $status_hColor == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
    ...
    public function borderTypo(array $args) {
      ...
      //  if( $status  == 'disabled' && $this->lgx_pro_ready == 'no') { return '';}
        ...
        $meta_width          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_width    = (( $status_width== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');


        // Radius
        $default_value_radius = isset( $args['default_radius'] ) ? $args['default_radius'] : '';
        $meta_radius          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_radius     = (( $status_radius == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
   ...
   /**
    ...
    public function textMulti(array $args) {
        ...
        $meta_1             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_1     = (( $status_1== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
        ...
        $item_html_1    .= '</div>';//item 1
         ...
         if( isset($args['id_2'])) {
             ...
             $meta_2             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
             ...
             $is_pro_label_2     = (( $status_2== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
          ...
          if( isset($args['id_3'])) {
              ...
              $meta_3             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
              ...
              $is_pro_label_3    = (( $status_3== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
           ...
           if( isset($args['id_4'])) {
               ...
               $meta_4             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
               ...
               $is_pro_label_4    = (( $status_4== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
             ...
             if( isset($args['id_5'])) {
                 ...
                 $meta_5             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
                 ...
                 $is_pro_label_5    = (( $status_5== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
               ...
               if( isset($args['id_6'])) {
                   ...
                   $meta_6             = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
                   ...
                   $is_pro_label_6    = (( $status_6== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
     ...
     */
     ...
     public function textTypo(array $args) {
        ...
        $status_color           = (isset( $args['status_color'] ) ? $args['status_color'] : '');
        $is_pro_color           = (( $status_color == 'disabled') ? 'disabled' : '');
        $is_pro_label_color     = (( $status_color == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->plugin ).'</span></span>' : '');


        // Size
        $default_value_size = isset( $args['default_size'] ) ? $args['default_size'] : '';
        $meta_size          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_size     = (( $status_size == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');


        // Weight
        $default_value_weight = isset( $args['default_weight'] ) ? $args['default_weight'] : '';
        $meta_weight          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
        ...
        $is_pro_label_weight     = (( $status_weight == 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
    ...
    //    if( $status  == 'disabled' && $this->lgx_pro_ready == 'no') { return '';}
        ...
        $status       = (isset( $args['status'] ) ? $args['status'] : '');
        $is_pro       = (( $status == 'disabled') ? 'disabled' : '');
        $is_pro_label = (( $status== 'disabled') ? '<span class="lgx_meta_field_mark_pro_wrap"><span class="lgx_meta_field_mark">'.__('Pro', $this->lgx_meta_from_plugin_name).'</span></span>' : '');
       ...
       $meta_text          = get_post_meta( $post->ID, '_save_meta_lgx_parallax_generator', true );
    ...
    array(
        'label'   => __( 'Show Brand Name', $this->lgx_meta_from_plugin_name ),
        'desc'    => __( 'Show brand name in your showcase.', $this->lgx_meta_from_plugin_name ),
    ...
    public function header_spacer_light( array $args ) {
        global $post;
        ...
        $output= '<tr>';
        $output.= '<td colspan="2" >';
        $output.= '<div  class="lgx_app_meta_header_spacer lgx_app_meta_header_spacer_light"><h3>'. $args['label'].'</h3></div>';
        //$output.= '<p class="lgx_input_desc lgx_app_meta_desc">'. $args['desc'].'</p>';
        $output.= '</td>';
        $output.= '</tr>';
    ...
    public function number( array $args ) {
        ...
        $step_value = isset( $args['step'] ) ? $args['step'] : 'any';
        $min_add    = isset( $args['min'] ) ? 'min="'.$args['min'].'"' : '';
        $max_add    = isset( $args['max'] ) ? 'max="'.$args['max'].'"' : '';
        ...
        $output.= '<td>';
        $output.= '<input type="number" step="'.$step_value.'"  '. $min_add .' '. $max_add .'  value="'.$meta_value.'" placeholder="'.$meta_value.'" id="'.$args['id'].'" class="lgx_input_width lgx_app_meta_filed " name="'. $args['name'].'" '.$is_pro.'>';
        $output.= $is_pro_label;
        $output.= '</td>';
    ...
    public function textarea( array $args ) {
        ...
        $output.= '<td>';
        $output.= '<textarea  name="'. $args['name'].'" placeholder="'. __( $args['name'], $this->lgx_meta_from_plugin_name ).'"  class="lgx_input_width lgx_app_meta_filed lgx_app_meta_textarea" '.$is_pro.'>'.$meta_value.'</textarea>';
        $output.= $is_pro_label;
        $output.= '</td>';
