		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 29, 2023 <span class="changelog-version">Lite Version 5.2.6</span></div>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 29, 2023 <span class="changelog-version">Pro Version 5.2.7</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Woo Single Tabs : Add Controller for Enable/Disable Reviews in Individual Review Form','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Display Condition : Location Condition Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Search Bar : Condition Improvement','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
