...
Tags:the events calendar, events, calendar, events calendar, event, modern tribe, booking, event calendar, theeventscalendar, event management
...
Using the **event single page builder addon**, you can showcase your single event page with beautiful design, and you can easily customize the colors in the **event single template** settings.
...
### ➕ More Add-ons to Extend The Events Calendar
...
3. You can edit the single event template colors and other settings from **Events Addons >> Single Event Template**.

== Frequently Asked Questions ==

= How it works? =

This plugin works as an add-on for **The Events Calenar** plugin. First you need to install and activate free version of "The Events Calendar" then install this addon and design event single page for the events created via The Events Calendar plugin.

= How to show events in list or grid layout? =
