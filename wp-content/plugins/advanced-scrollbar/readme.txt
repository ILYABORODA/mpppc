...
Customize your scrollbar. Change color, width, Background, Scroll Speed, align the Rail of the scrollbar and more. Design the scrollbar by following your brands identity. This plugin is lightweight and very easy to use. 
...
* Compatible with all devices including Mobile phone, Tablet Pc, Desktop


= Feedback = 
Liked that plugin? Hate it? Want a new feature?  [Send your feedback](https://bPlugins.com/support "Send feedback")  
...
= Is the plugin contain ad ? =

No, The plugin is ad less and totally free of cost.
...
= 1.1 =
* Removed The admin menu from dashboard.
