...
<div class="rtw_sb_popup">
	<div class="rtw_sb_card">
		...
		<div class="rtw_sb_card_body">
			...
			<p class="rtw_sb_bottom_text">* Hurry up offer valid till <span class="rtw_sb_date">31st March</span></p>
		</div>
	</div>
</div>

<div class="wrap rtw_pgaepb">
		<p class="rtw_pgaepb_currver"><?php _e('ver '.RTW_PGAEPA_NAME_VERSION,'wordpress-plugin-runtime-handler');?></p>
