	...
	<tbody>
		...
		<tr>
			...
			<td class="tr2">
				...
				<div class="descr"><?php _e('Select what will be the name of the generated PDF', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th class="tr1"><?php _e('Show PDF Button', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<p>
				...
				<div class="descr"><?php _e('Choose the page where you want show Download PDF button', 'pdf-generator-addon-for-elementor-page-builder');?></div>
			</td>
		</tr>
		<tr>
			<th class="tr1"><?php _e('Disable Copy', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				...
				<div class="descr"><?php _e('Check it if you want to disable copying of content from the generated PDF','pdf-generator-addon-for-elementor-page-builder');?>
				</div>
			</td>
		</tr>
	</tbody>	
