...
<table id="rtw_text_remv_footer" class="wp-list-table form-table <?= isset($rtw_wprh_get_setting['rtw_remove_footer'])  ? 'display_none' : '' ?>">
	<tbody>
		...
		<tr>
			<th class="tr1"><?php _e('Hide Page Number', 'pdf-generator-addon-for-elementor-page-builder');?></th>
			<td class="tr2">
				<input type="checkbox" name="rtw_pgaepb_footer_setting_opt[rtw_footer_hide_pageno]" value="1" <?php echo isset( $rtw_wprh_get_setting['rtw_footer_hide_pageno'] ) && $rtw_wprh_get_setting['rtw_footer_hide_pageno'] == 1 ? 'checked="checked"' : ''; ?> />
				<div class="descr"><?php _e('Check it if you want to hide page number in PDF Footer','pdf-generator-addon-for-elementor-page-builder');?></div>
