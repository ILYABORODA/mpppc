 ...
 * Description:       PDF Generator Addon for WordPress Elementor Page Builder allows to create a static look and generate PDF of pages and posts.
 * Version:           1.7.0
...
if( function_exists('is_multisite') && is_multisite() )
{
	...
	if( !is_plugin_active('rtwwpge-wordpress-pdf-generator-for-elementor/rtwwpge-wordpress-pdf-generator-for-elementor.php') )
	{
		 ...
		 */
		define( 'RTW_PGAEPA_NAME_VERSION', '1.7.0' );
